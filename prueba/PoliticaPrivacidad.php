...
<body>
    ...
    <section class="hero-section">
        ...
        <div id="contact-card">
            ...
            <p>
                La información personal proporcionada por los usuarios será utilizada únicamente para la gestión de reservas,
                atención al cliente y cumplimiento de obligaciones legales.
            </p>

            <p>
                No compartimos ni vendemos datos personales a terceros, salvo cuando sea necesario para prestar el servicio
